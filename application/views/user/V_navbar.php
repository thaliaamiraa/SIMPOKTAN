      ...
      <div class="navbar-menu-wrapper d-flex align-items-stretch">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-logout d-none d-lg-block">
            <a class="nav-link" href="<?= site_url('C_user/logout') ?>">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              ...
              <div class="nav-profile-text d-flex flex-column">
                ...
                <span class="text-secondary text-small"><?= $this->session->userdata('username_user');?></span>
              </div>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url() ?>c_user/dashboard">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url() ?>c_user/kecamatan">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url() ?>c_user/desa">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url() ?>c_user/hasil_pertanian/">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url() ?>c_klasterisasi_user/">
